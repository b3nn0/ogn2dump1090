...
sudo apt update
sudo apt install python3-pip git lighttpd build-essential fakeroot debhelper pkg-config libncurses5-dev libfftw3-bin libusb-1.0-0-dev lynx ntp ntpdate procserv telnet -y
